...
CREATE TABLE IF NOT EXISTS `Surf_desafio`.`Bateria` (
  ...
  `Surfista_numero1` INT(15) NOT NULL,
  `Surfista_numero2` INT(15) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_Bateria_Surfista_idx` (`Surfista_numero1` ASC) VISIBLE,
  INDEX `fk_Bateria_Surfista2_idx` (`Surfista_numero2` ASC) VISIBLE,
  CONSTRAINT `fk_Bateria_Surfista`
    FOREIGN KEY (`Surfista_numero1`)
    REFERENCES `Surf_desafio`.`Surfista` (`numero`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Bateria_Surfista2`
    FOREIGN KEY (`Surfista_numero2`)
    REFERENCES `Surf_desafio`.`Surfista` (`numero`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `Surf_desafio`.`Nota` (
  ...
  `notaparcial1` DECIMAL(30) NULL DEFAULT NULL,
  `notaparcial2` DECIMAL(30) NULL DEFAULT NULL,
  `notaparcial3` DECIMAL(30) NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
